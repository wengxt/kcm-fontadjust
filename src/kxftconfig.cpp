...
KXftConfig::FontStyle KXftConfig::getStyle()
{
    FontStyle style;
    getSubPixelType(style.subPixel);
    style.antiAliasing = getAntiAliasing();
    getHintStyle(style.hint);
    return style;
}

void KXftConfig::setStyle(KXftConfig::FontStyle style)
{
    setAntiAliasing(style.antiAliasing);
    setHintStyle(style.hint);
    setSubPixelType(style.subPixel);
}
